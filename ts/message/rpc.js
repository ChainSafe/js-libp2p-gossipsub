  ...
  $root.RPC = (function () {
    ...
    RPC.Message = (function () {
      ...
      Message.fromObject = function fromObject(d) {
        ...
        if (d.from != null) {
          ...
          else if (d.from.length) m.from = d.from
        }
        if (d.data != null) {
        ...
        if (d.seqno != null) {
          ...
          else if (d.seqno.length) m.seqno = d.seqno
        }
        if (d.topicIDs) {
      ...
      Message.toObject = function toObject(m, o) {
        ...
        if (m.from != null && m.hasOwnProperty('from')) {
          d.from =
            o.bytes === String
              ? $util.base64.encode(m.from, 0, m.from.length)
              : o.bytes === Array
              ? Array.prototype.slice.call(m.from)
              : m.from
        ...
        if (m.seqno != null && m.hasOwnProperty('seqno')) {
          d.seqno =
            o.bytes === String
              ? $util.base64.encode(m.seqno, 0, m.seqno.length)
              : o.bytes === Array
              ? Array.prototype.slice.call(m.seqno)
              : m.seqno
        ...
        if (d.messageIDs) {
          ...
          for (var i = 0; i < d.messageIDs.length; ++i) {
            if (typeof d.messageIDs[i] === 'string')
              $util.base64.decode(
                d.messageIDs[i],
                (m.messageIDs[i] = $util.newBuffer($util.base64.length(d.messageIDs[i]))),
                0
              )
            else if (d.messageIDs[i].length) m.messageIDs[i] = d.messageIDs[i]
          }
        }
        return m
      }
      ...
      ControlIHave.toObject = function toObject(m, o) {
        ...
        if (m.messageIDs && m.messageIDs.length) {
          ...
          for (var j = 0; j < m.messageIDs.length; ++j) {
            d.messageIDs[j] =
              o.bytes === String
                ? $util.base64.encode(m.messageIDs[j], 0, m.messageIDs[j].length)
                : o.bytes === Array
                ? Array.prototype.slice.call(m.messageIDs[j])
                : m.messageIDs[j]
          }
        }
        return d
    ...
    RPC.ControlPrune = (function () {
      ...
      ControlPrune.fromObject = function fromObject(d) {
        ...
        if (d.backoff != null) {
          if ($util.Long) (m.backoff = $util.Long.fromValue(d.backoff)).unsigned = true
          else if (typeof d.backoff === 'string') m.backoff = parseInt(d.backoff, 10)
          else if (typeof d.backoff === 'number') m.backoff = d.backoff
      ...
      ControlPrune.toObject = function toObject(m, o) {
        ...
        if (m.backoff != null && m.hasOwnProperty('backoff')) {
          if (typeof m.backoff === 'number') d.backoff = o.longs === String ? String(m.backoff) : m.backoff
          else
            d.backoff =
              o.longs === String
                ? $util.Long.prototype.toString.call(m.backoff)
                : o.longs === Number
                ? new $util.LongBits(m.backoff.low >>> 0, m.backoff.high >>> 0).toNumber(true)
                : m.backoff
    ...
    RPC.PeerInfo = (function () {
      ...
      PeerInfo.fromObject = function fromObject(d) {
        ...
        if (d.signedPeerRecord != null) {
          if (typeof d.signedPeerRecord === 'string')
            $util.base64.decode(
              d.signedPeerRecord,
              (m.signedPeerRecord = $util.newBuffer($util.base64.length(d.signedPeerRecord))),
              0
            )
      ...
      PeerInfo.toObject = function toObject(m, o) {
        ...
        if (m.peerID != null && m.hasOwnProperty('peerID')) {
          d.peerID =
            o.bytes === String
              ? $util.base64.encode(m.peerID, 0, m.peerID.length)
              : o.bytes === Array
              ? Array.prototype.slice.call(m.peerID)
              : m.peerID
        ...
        if (m.signedPeerRecord != null && m.hasOwnProperty('signedPeerRecord')) {
          d.signedPeerRecord =
            o.bytes === String
              ? $util.base64.encode(m.signedPeerRecord, 0, m.signedPeerRecord.length)
              : o.bytes === Array
              ? Array.prototype.slice.call(m.signedPeerRecord)
              : m.signedPeerRecord
